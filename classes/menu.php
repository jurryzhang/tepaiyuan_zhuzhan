...
class Menu
{
	...
	public static $menu = array(
		...
		'会员'=>array(
			...
			'市场管理' => array(
				'/member/market_list' => '市场列表',
				'/member/market_edit' => '添加市场',
			),
			'商户管理' => array(
            ...
            '派送员管理' => array(
                '/member/freight_list' => '派送员列表',
                // '/member/freight_edit' => '添加派送员',
                // '/comment/freight_message_list' => '商户消息'
            ),
			'信息处理' => array(
	   ...
	   '订单'=>array(
        	...
        	'单据管理'=>array(
             	...
             	'/order/returnment_list'        => '退货退款申请列表',
             	// '/order/order_returnment_list'  => '退货退款单',
        	),
        	'发货地址'=>array(
